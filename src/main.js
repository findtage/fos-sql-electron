...
if (process.platform != "darwin") require("update-electron-app")({ repo: "Findtage/Fos-Electron-Build" });
...
const createWindow = () => {
  ...
  new Promise((resolve) =>
    setTimeout(() => {
      mainWindow.loadURL("https://fantageos.com/");
      resolve();
    }, 5000)
  );
};
...
const launchMain = () => {
  ...
  app.setAsDefaultProtocolClient("fantageos");
